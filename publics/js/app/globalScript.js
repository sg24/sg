...
var Nav = function () {
    function Nav() {
        ...
        this.navPtToggler = (0, _jquery2.default)(".nav__pt");
        this.navPtIcn = (0, _jquery2.default)(".nav__pt > h4 > span");
        this.navPt = (0, _jquery2.default)(".nav__pt > ul");
        this.navQueToggler = (0, _jquery2.default)(".nav__que");
        this.navQue = (0, _jquery2.default)(".nav__que > ul");
        this.navQueIcn = (0, _jquery2.default)(".nav__que > h4 > span");
        this.navGrpToggler = (0, _jquery2.default)(".nav__grp");
        this.navGrp = (0, _jquery2.default)(".nav__grp > ul");
        this.navGrpIcn = (0, _jquery2.default)(".nav__grp > h4 > span");
        this.navPwtToggler = (0, _jquery2.default)(".nav__pwt");
        this.navPwt = (0, _jquery2.default)(".nav__pwt > ul");
        this.navPwtIcn = (0, _jquery2.default)(".nav__pwt > h4 > span");
        this.navOnqueToggler = (0, _jquery2.default)(".nav__online-que");
        this.navOnque = (0, _jquery2.default)(".nav__online-que > ul");
        this.navOnqueIcn = (0, _jquery2.default)(".nav__online-que> h4 > span");
        this.navOnqueSmToggler = (0, _jquery2.default)(".nav__online-que-sm");
        this.navOnqueSm = (0, _jquery2.default)(".nav__online-que-sm > ul");
        this.navOnqueIcnSm = (0, _jquery2.default)(".nav__online-que-sm> h4 > span");
        this.navOptToggler = (0, _jquery2.default)(".nav__other");
        this.navOpt = (0, _jquery2.default)(".nav__other > ul");
        this.navOptIcn = (0, _jquery2.default)(".nav__other > h4 > span");
        this.navOptSmToggler = (0, _jquery2.default)(".nav__other-sm");
        this.navOptSm = (0, _jquery2.default)(".nav__other-sm > ul");
        this.navOptIcnSm = (0, _jquery2.default)(".nav__other-sm > h4 > span");
        this.events();
    }
...
var Scroll = function () {
    function Scroll() {
        ...
        this.menu = (0, _jquery2.default)(".site-main");
        this.siteMain = (0, _jquery2.default)(".site-main__content--tab");
        this.scrollItems();
        this.siteHeaderScroll();
    }

    _createClass(Scroll, [{
        key: 'siteHeaderScroll',
        value: function siteHeaderScroll() {
            var that = this;
            new Waypoint({
                element: this.menu[0],
...
var SiteHeader = function () {
    function SiteHeader() {
        ...
        this.siteBody = (0, _jquery2.default)(".reuse-view, .site-main");
        this.form = (0, _jquery2.default)(".site-header__form");
        this.formInput = (0, _jquery2.default)(".site-header__form--input");
        this.addNewToggler = (0, _jquery2.default)(".site-header__add-new");
        this.addNew = (0, _jquery2.default)(".site-header__add-new--opt");
        this.navOpt = (0, _jquery2.default)(".site-header__nav-opt");
        this.nofityToggler = (0, _jquery2.default)(".site-header__menu--notify__icn, .site-header__menu--notify__num");
        this.notify = (0, _jquery2.default)(".site-header__menu--notify__cnt");
        this.navToggler = (0, _jquery2.default)(".site-header__menu--nav__icn");
        this.nav = (0, _jquery2.default)(".nav");
        this.userOptToggler = (0, _jquery2.default)(".site-header__user");
        this.userOpt = (0, _jquery2.default)(".site-header__user--det");
        this.formSmOpen = (0, _jquery2.default)(".site-header__form-sm");
        this.formSm = (0, _jquery2.default)(".site-header__sm-form");
        this.formSmClose = (0, _jquery2.default)(".site-header__sm-form--close");
        this.events();
    }
    ...
    _createClass(SiteHeader, [{
        ...
        key: "openFormSm",
        value: function openFormSm() {
            this.formSm.addClass("site-header__sm-form--visible");
        }
    }, {
        key: "closeFormSm",
        value: function closeFormSm() {
...
var SiteNav = function () {
    function SiteNav() {
        ...
        this.setQueToggler = (0, _jquery2.default)(".reuse-set__categ");
        this.setQue = (0, _jquery2.default)(".reuse-set__categ--opt");
        this.events();
    }
...
var ToolTips = function () {
    function ToolTips() {
        ...
        this.favToggler = (0, _jquery2.default)(".site-header__menu--fav");
        this.fav = (0, _jquery2.default)(".site-header__tool-tip--fav");
        this.shareToggler = (0, _jquery2.default)(".site-header__menu--share");
        this.share = (0, _jquery2.default)(".site-header__tool-tip--share");
        this.notifyToggler = (0, _jquery2.default)(".site-header__menu--notify__icn");
        this.notify = (0, _jquery2.default)(".site-header__tool-tip--notify");
        this.navToggler = (0, _jquery2.default)(".site-header__menu--nav__icn");
        this.nav = (0, _jquery2.default)(".site-header__tool-tip--nav");
        this.events();
    }
...
var _SiteNav = __webpack_require__(13);

var _SiteNav2 = _interopRequireDefault(_SiteNav);

var _ToolTips = __webpack_require__(14);
...
var _Conv = __webpack_require__(9);
...
var Conv = function () {
    function Conv() {
        ...
        this.pvtOptToggler = (0, _jquery2.default)(".reuse-pvt-chat__opt");
        this.pvtOpt = (0, _jquery2.default)(".reuse-pvt-chat__opt--det");
        this.grpOptToggler = (0, _jquery2.default)(".reuse-grp-chat__opt");
        this.grpOpt = (0, _jquery2.default)(".reuse-grp-chat__opt--det");
        this.events();
    }
