...
var Content = function () {
    function Content() {
        ...
        this.replyTogger = (0, _jquery2.default)(".reuse-view__comments--box__footer--user-opt__reply");
        this.reply = (0, _jquery2.default)(".reuse-view__comments--box__reply");
        this.closeallReply = (0, _jquery2.default)(".reuse-view__comments--box__reply--main-close");
...
var Share = function () {
    function Share() {
        ...
        this.shareToggler = (0, _jquery2.default)(".reuse-share__icn");
        this.share = (0, _jquery2.default)(".reuse-share__wrapper");
        this.userToggler = (0, _jquery2.default)(".reuse-share__title");
        this.userTogglerIcn = (0, _jquery2.default)(".reuse-share__title--icn");
        this.user = (0, _jquery2.default)(".reuse-share__content");
        this.userWrap = (0, _jquery2.default)(".reuse-share__content--user__wrapper");
        this.userWrapHIcn = (0, _jquery2.default)(".reuse-share__content--user__hov-icn");
        this.userWrapClk = (0, _jquery2.default)(".reuse-share__content--user__clk-icn");
        this.userAnsToggler = (0, _jquery2.default)(".reuse-share__content--user__ans");
        this.userSntsToggler = (0, _jquery2.default)(".reuse-share__content--user__snts");
        this.userAns = (0, _jquery2.default)(".reuse-share__content--user__tooltip--ans");
        this.userSnts = (0, _jquery2.default)(".reuse-share__content--user__tooltip--snts");
        this.viewUserToggler = (0, _jquery2.default)(".reuse-share__user-counter--viewall");
        this.viewUserClose = (0, _jquery2.default)(".reuse-share__user-selected--mainclose");
        this.viewUser = (0, _jquery2.default)(".reuse-share__user-selected");
        this.userCount = (0, _jquery2.default)(".reuse-share__user-counter");
        this.vwOptToggler = (0, _jquery2.default)(".reuse-view__main--footer__user-det");
        this.vwOpt = (0, _jquery2.default)(".reuse-view__main--footer__user-det--opt");
        this.usOptToggler = (0, _jquery2.default)(".reuse-view__comments--box__footer--user-det");
        this.usOpt = (0, _jquery2.default)(".reuse-view__comments--box__footer--user-det__opt");
        this.overlay = (0, _jquery2.default)(".site-main__content--overlay");
        this.events();
    }
...
var _UserOpt = __webpack_require__(36);

var _UserOpt2 = _interopRequireDefault(_UserOpt);
...
var userOpt = new _UserOpt2.default();
