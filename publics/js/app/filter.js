...
var Filter = function () {
    function Filter() {
        ...
        this.categToggler = (0, _jquery2.default)(".reuse-categ");
        this.categ = (0, _jquery2.default)(".reuse-categ__opt");
        this.filterToggler = (0, _jquery2.default)(".reuse-filter__title");
        this.filter = (0, _jquery2.default)(".reuse-filter__opt");
        this.overlay = (0, _jquery2.default)(".site-main__content--overlay");
        this.filterClose = (0, _jquery2.default)(".reuse-filter__opt--btn__cancel, .reuse-filter__opt--btn__apply");
        this.events();
    }
