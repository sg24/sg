...
var Share = function () {
    function Share() {
        ...
        this.closeShare = (0, _jquery2.default)(".reuse-filter, .reuse-categ");
        this.queOptToggler = (0, _jquery2.default)(".reuse-que__footer--details");
        this.queOpt = (0, _jquery2.default)(".reuse-que__footer--details__options");
        this.ptOptToggler = (0, _jquery2.default)(".reuse-pt__footer--details");
        this.ptOpt = (0, _jquery2.default)(".reuse-pt__footer--details__options");
        this.onqueOpt = (0, _jquery2.default)(".reuse-onlineque__content--posted__user--det__opt");
        this.pwtOpt = (0, _jquery2.default)(".reuse-pwt__content--det__user--det__opt");
        this.events();
    }
...
var _Share = __webpack_require__(29);
