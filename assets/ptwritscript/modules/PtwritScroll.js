...
class PtwritScroll {
    constructor() {
        ...
        this.menu = $(".site-main");
        this.tabMenu = $(".site-main__content--wrapper");
        this.tab = $(".site-main__content--tab");
        this.navSticky();
        this.tabSticky();
    }
        ...
        new Waypoint({
            ...
            handler: function(direction) { 
                if (direction == "down") { 
                    ...
                    that.tab.addClass("site-main__content--tab__sticky");
                } else { 
                    that.tab.removeClass("site-main__content--tab__sticky");
