...
class QuestionFilter {
    constructor() {
        ...
        this.filterOverlay =$(".site-main__onlineQue--overlay");
        this.filterClose = $(".site-main__onlineQue--overlay, .onlinequefilter__filter--options__search--found__total, .onlinequefilter__filter--options__search--btn__ok, .onlinequefilter__filter--options__search--btn__cancel");
    ...
    toggleCateg() {
        ...
        this.filterOverlay.toggleClass("site-main__onlineQue--overlay__visible");
    }
    ...
    closeAllFilter() {
        ...
        this.seleCateg.removeClass("onlinequefilter__filter--options__search--categsm__item--visible");
        this.seleCategIcon.removeClass("icon--rotate");
        this.filterOverlay.removeClass("site-main__onlineQue--overlay__visible");
        this.categ.removeClass("onlinequefilter__category--item__visible");
        this.categToggler.removeClass("icon--rotate");
    }
