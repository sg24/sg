...
class PtwritFilter {
    constructor() {
        ...
        this.filterClose = $(".ptwritfilter__filter--options__search--found__total, .ptwritfilter__filter--options__search--btn__ok, .ptwritfilter__filter--options__search--btn__cancel");
