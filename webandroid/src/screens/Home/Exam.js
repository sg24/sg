...
class Exam extends Component {
    ...
    submitAnswerHandler = () => {
        clearInterval(this.state.durationID);
        this.props.onPageReaction('exam', JSON.stringify({pageID: this.state.pageID, answer: this.state.selectedAnswer, 
            questionTotal: this.props.fetchCnt[0].question.length}), 'markExam');
                            ...
                            <View>
                                <View style={styles.pageInfo}>
                                    ...
                                    <Button 
                                        ...
                                        disabled={this.state.totalDuration === 0 || this.state.selectedAnswer.length < 1}
                                        onPress={this.submitAnswerHandler}
                                        submitting={this.state.totalDuration === 0}
                                        loaderStyle="#fff">
