...
const mapStateToProps = state => {
    return {
        editFormErr: state.editForm.fetchGroupPostError,
        editFormCnt: state.editForm.fetchGroupPost,
        submitError: state.editForm.grouppostSubmitError,
        submitted: state.editForm.grouppostSubmitted,
        start: state.editForm.grouppostStart,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchEditForm: (cntID) => dispatch(actions.fetchEditFormInit(cntID, 'grouppost')),
        onSubmitForm: (formData) => dispatch(actions.submitEditFormInit(formData, 'grouppost')),
