...
const mapStateToProps = state => {
    return {
        editFormErr: state.editForm.fetchGroupQuestionError,
        editFormCnt: state.editForm.fetchGroupQuestion,
        submitError: state.editForm.groupquestionSubmitError,
        submitted: state.editForm.groupquestionSubmitted,
        start: state.editForm.groupquestionStart,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchEditForm: (cntID) => dispatch(actions.fetchEditFormInit(cntID, 'groupquestion')),
        onSubmitForm: (formData) => dispatch(actions.submitEditFormInit(formData, 'groupquestion')),
        onSubmitFormReset: () => dispatch(actions.submitEditFormReset())
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(GroupQuestion);