    ...
    componentDidUpdate() {
        if (!this.state.loaded && this.props.editFormCnt) {
            ...
            this.setState({
                ...
                comment: {value: form.enableComment, validation: {}, valid: true } },formIsValid: true, uploadFile,loaded: true,fetchedUploadFile: uploadFile
            });
        }
        if (this.state.resetAll) {
            this.setState({
                ...
                uploadFile: [],inputUri: [], showUpload: false, loaded: false,fetchedUploadFile: [],resetAll: false
            })
        }
    }
...
const mapStateToProps = state => {
    return {
        editFormErr: state.editForm.fetchGroupFeedError,
        editFormCnt: state.editForm.fetchGroupFeed,
        submitError: state.editForm.groupfeedSubmitError,
        submitted: state.editForm.groupfeedSubmitted,
        start: state.editForm.groupfeedStart,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchEditForm: (cntID) => dispatch(actions.fetchEditFormInit(cntID, 'groupfeed')),
        onSubmitForm: (formData) => dispatch(actions.submitEditFormInit(formData, 'groupfeed')),
