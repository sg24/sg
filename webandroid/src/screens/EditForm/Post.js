...
const mapStateToProps = state => {
    return {
        editFormErr: state.editForm.fetchPostError,
        editFormCnt: state.editForm.fetchPost,
        submitError: state.editForm.postSubmitError,
        submitted: state.editForm.postSubmitted,
        start: state.editForm.postStart,
