...
class CBT extends Component {
    ...
    componentDidMount() {
        if (this.state.cntID) {
            ...
            this.props.navigation.navigate(this.state.viewMode === 'landscape' ? 'CBTWeb' : 'CBT')
        }
                ...
                <View style={styles.formWrapper}>
                    ...
                    { this.props.submitted ? 
                        <NotificationModal
                            ...
                            button={[{title: 'View', onPress: () => this.navigationHandler(this.state.viewMode === 'landscape' ? 'CBT' : 'HomeWeb', 
...
const mapStateToProps = state => {
    return {
        editFormErr: state.editForm.fetchCbtError,
        editFormCnt: state.editForm.fetchCbt,
        submitError: state.editForm.cbtSubmitError,
        submitted: state.editForm.cbtSubmitted,
        start: state.editForm.cbtStart,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchEditForm: (cntID) => dispatch(actions.fetchEditFormInit(cntID, 'cbt')),
        onSubmitForm: (formData) => dispatch(actions.submitEditFormInit(formData, 'cbt')),
