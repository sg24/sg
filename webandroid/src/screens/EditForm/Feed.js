...
const mapStateToProps = state => {
    return {
        editFormErr: state.editForm.fetchFeedError,
        editFormCnt: state.editForm.fetchFeed,
        submitError: state.editForm.feedSubmitError,
        submitted: state.editForm.feedSubmitted,
        start: state.editForm.feedStart,
