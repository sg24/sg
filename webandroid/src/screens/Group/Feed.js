...
class Feed extends Component {
    ...
    reloadFetchHandler = () => {
        if (this.state.search.trim().length > 0) {
            return this.props.onSearchCnt(this.props.fetchCnt ? this.props.fetchCnt.length : 0, this.props.settings.page.fetchLimit, 'groupfeed', 'searchFeed', JSON.stringify({search: this.state.search, groupID: this.state.groupID}));
        }
        this.props.onFetchPage(this.props.fetchCnt ? this.props.fetchCnt.length : 0, this.props.settings.page.fetchLimit, 'groupfeed', 'getFeed', this.state.groupID);
    }
    ...
    searchPageHandler = (cnt) => {
        ...
        if (cnt && cnt.length > 0) {
            this.props.onSearchCnt(0, this.props.settings.page.fetchLimit, 'groupfeed', 'searchFeed', JSON.stringify({search: cnt, groupID: this.state.groupID}));
        }
    }
    ...
    loadMoreHandler = () => {
        if (this.state.search.trim().length > 0) {
            return this.props.onSearchCnt(this.props.fetchCnt ? this.props.fetchCnt.length : 0, this.props.settings.page.fetchLimit,
                 'groupfeed', 'searchFeed', JSON.stringify({search: this.state.search, groupID: this.state.groupID}));
        }
        this.props.onFetchPage(this.props.fetchCnt ? this.props.fetchCnt.length : 0, this.props.settings.page.fetchLimit, 'groupfeed', 'getFeed', this.state.groupID);
    }
...
const mapStateToProps = state => {
    return {
        ...
        fetchCnt: state.page.fetchGroupFeed,
