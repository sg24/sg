    ...
    componentDidUpdate() {
        if (this.state.resetAll) {
            this.setState({
                ...
                showUpload: false,examDetail: null, resetAll: false
            })
        }
    }
            ...
            <View style={styles.formWrapper}>
                ...
                { this.props.submitted ? 
                    <NotificationModal
                        ...
                        button={[{title: 'View', onPress: () => this.navigationHandler('GroupPreview', {pageID: this.state.groupID, page: 'cbt'})},
...
const mapStateToProps = state => {
    return {
        submitError: state.addForm.groupcbtSubmitError,
        submitted: state.addForm.groupcbtSubmitted,
        start: state.addForm.groupcbtStart,
...
const mapDispatchToProps = dispatch => {
    return {
        onSubmitForm: (formData) => dispatch(actions.submitAddFormInit(formData, 'groupcbt')),
