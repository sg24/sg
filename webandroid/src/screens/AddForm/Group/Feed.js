            ...
            <View style={styles.formWrapper}>
                ...
                { this.props.submitted ? 
                    <NotificationModal
                        ...
                        button={[{title: 'View', onPress: () =>  this.navigationHandler('GroupPreview', {pageID: this.state.groupID, page: 'feed'})},
...
const mapStateToProps = state => {
    return {
        submitError: state.addForm.groupfeedSubmitError,
        submitted: state.addForm.groupfeedSubmitted,
        start: state.addForm.groupfeedStart,
...
const mapDispatchToProps = dispatch => {
    return {
        onSubmitForm: (formData) => dispatch(actions.submitAddFormInit(formData, 'groupfeed')),
