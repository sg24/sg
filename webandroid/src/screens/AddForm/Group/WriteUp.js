...
const mapStateToProps = state => {
    return {
        submitError: state.addForm.groupwriteupSubmitError,
        submitted: state.addForm.groupwriteupSubmitted,
        start: state.addForm.groupwriteupStart,
...
const mapDispatchToProps = dispatch => {
    return {
        onSubmitForm: (formData) => dispatch(actions.submitAddFormInit(formData, 'groupwriteup')),
