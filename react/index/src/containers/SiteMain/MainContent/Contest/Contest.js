...
class Contest extends Component {
    ...
    componentDidUpdate() {
        ...
        //     this.props.onFetchCntReset();;
        //     this.props.onFetchCnt(this.props.userID, `contest-${this.props.match.params.id}`, this.state.fetchLimit, 0, 0);
        //     this.setState({
    ...
    onScroll = () => {
        if ((window.innerHeight + Math.ceil(window.pageYOffset + 1)) >= document.body.offsetHeight) {
            this.props.onFetchCnt(
                    ...
                    this.state.filterTag === 'filter' ?  'filter=='+this.props.filterDet : `contest-${this.state.filterTag}` : 'contest' ,
    ...
    showChatHandler = (id) => {
        this.props.history.push(`/index/contest/${id}`)
    }
