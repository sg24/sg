...
import Around from '../../../../components/Main/Aroundme/Aroundme';
...
class Aroundme extends Component {
    ...
    componentDidUpdate() {
        ...
        //     this.props.onFetchCntReset();;
        //     this.props.onFetchCnt(this.props.userID, `aroundme-${this.props.match.params.id}`, this.state.fetchLimit, 0, 0);
        //     this.setState({
    ...
    onScroll = () => {
        if ((window.innerHeight + Math.ceil(window.pageYOffset + 1)) >= document.body.offsetHeight) {
            this.props.onFetchCnt(
                    ...
                    this.state.filterTag === 'filter' ?  'filter=='+this.props.filterDet : `aroundme-${this.state.filterTag}` : 'aroundme' ,
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Aroundme));