...
class Chat extends Component {
    ...
    componentDidMount() {
        let these = this;
        axios.post('/contest', {id: this.state.id}, {headers: {
    ...
    closeAroundmeHandler = () => {
        this.props.history.push('/index/contest')
    }
    ...
    render() {
        ...
        if (this.state.userDet) {
            let userImage = <Avatar  name={this.state.userDet.nickname ? this.state.userDet.nickname : this.state.userDet.username} size='40' round />
            ...
            let header = (
                ...
                <div className="site-main__chat--header__img">
                    ...
                    <h3 className="site-main__chat--header__title">
                        { this.state.userDet.nickname ? this.state.userDet.nickname : this.state.userDet.username }
                    </h3>
                    <div className="site-main__chat--header__det">
                        <div>
                            <FontAwesomeIcon  icon={['fas', 'mask']} className="icon icon__site-main--chat__header--map"/>
                        </div>
                        Face of slode24
                    </div> 
                </>
