    ...
    locationHandler = () => {
        ...
        if (('navigator' in window) && ('geolocation' in navigator)) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                axios.get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${fetchedLocation.lat},${fetchedLocation.lng}&key=AIzaSyD2OUDjZ-urf2MAVcxPc03HA4X8KbB-jlk`).then(locFnd => {
            ...
            <>
                ...
                <div className="aroundme__form--footer">
                    <button 
                        ...
                        disabled={!this.state.loc.value || this.state.media.length < 1}>
                            Chat 
                    </button>
                </div>
            </>
        ...
        return (
            <form 
                ...
                <div className="aroundme__form--main-wrapper">
                    <div className="aroundme__form--backdrop"  onClick={this.closeShareHandler}>
                    </div>  
