...
import Aroundme from '../../../../../components/Main/Aroundme/Aroundme';
...
class Around extends Component {
    ...
    componentDidMount() {
        ...
        this.props.onChangeTag('/aroundme');
    ...
    componentDidUpdate() {
        ...
        if (this.props.match.params.id && this.state.filterTag !== this.props.match.params.id && this.props.match.params.id !== 'share' && this.props.match.params.id !== 'preview'  && this.props.match.params.id !== 'add' && this.props.match.params.id !== 'filter' && this.props.match.params.id !== 'startfilter') {
        ...
        if (!this.props.match.params.id && this.state.filterTag !== 'aroundme') {
            this.props.onFetchCntReset();
            this.props.onFetchCnt(this.props.userID, 'aroundme', this.state.fetchLimit, 0, 0);
            this.setState({
                filterTag: 'aroundme'
            });
        }
    ...
    onScroll = () => {
        if ((window.innerHeight + Math.ceil(window.pageYOffset + 1)) >= document.body.offsetHeight) {
            this.props.onFetchCnt(
                    this.props.userID, 
                    this.state.filterTag !== 'aroundme' ? 
                    this.state.filterTag === 'filter' ?  'filter=='+this.props.filterDet : this.state.filterTag : 'aroundme',
    ...
    showShareHandler = (shareID) => {
        ...
        this.props.history.push('/aroundme/share')
    };
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Around));