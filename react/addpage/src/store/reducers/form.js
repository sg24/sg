...
const fetchUsers = (state, action) => {
    return updateObject(state, {
        ...
        curTab: action.status, cntErr: action.null})
};

const fetchUsersFail = (state, action) => {
    return updateObject(state, {users: null, filteredUser: null, startUser: false, cntErr: action.err})
};

const fetchGroup = (state, action) => {
    return updateObject(state, { groups: action.groups , cntErr: null})
};

const fetchGroupFail = (state, action) => {
    return updateObject(state, {groups: null, cntErr: action.err})
};
...
const groupSelect = (state, action) => {
    return updateObject(state, {media: action.groups})
};
...
const submitFormFail = (state, action) => {
    return updateObject(state, {submitError: {message: action.err.message, code: action.err.code},  defaultValue: false,
        uploadPercent: null})
};

const submitFormReset = (state, action) => {
    return updateObject(state, {submitForm: false, submitError: null, submitFiles: 0})
};
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.GROUP_SELECT:
            return groupSelect(state, action);
