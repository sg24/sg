...
let Editor  = typeof window !== 'undefined' ? require('react-draft-wysiwyg').Editor : null ;
...
const AsyncVideo = dynamic(() => {
    return import ('./AddVideo/AddVideo');
});

const AsyncUsers = dynamic(() => {
...
class Form extends  Component {
    ...
    componentDidMount() {
        this.props.onFetchCnt(this.props.router.params.id);
    }
