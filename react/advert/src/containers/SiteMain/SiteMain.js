    ...
    render() {
        ...
        return (
            ...
            {this.props.showBackdrop ? 
                ...
                <Switch>
                    <Route path="/advert" exact component={MainContent} />
                ...
                { this.props.changeCntStart !== null ? 
                    <Backdrop   
                        ...
                        warn={{
                            ...
                            'Are you sure you want to delete this advert' : 'Are you sure you want to change this advert mode',
                            cnt: this.props.changeCntStart.title,
                            det: this.props.changeCntStart.det
                        }}
                        exit={{
                            msg: this.props.changeCntStart.det=== 'delete' ?
                            'Advert Deleted Successfully' : 'Advert mode change successfully', 
