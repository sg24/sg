...
class FilterContent extends Component {
    ...
    componentDidMount() {
        this.props.history.push('/advert/startfilter')
        if (!this.props.categ) {
    ...
    render() {
        ...
        if (this.props.filterErr) {
            filterSrchClass = ['reuse-filter__opt--srch']
            totalFoundCnt = (
                <div className="reuse-ads__filter-err"> {this.props.filterErr.message} </div>
            )
        }
                ...
                <div className="reuse-filter__opt--cnt">
                    <div className="reuse-filter__opt--cnt__wrapper reuse-filter__opt--cnt__wrapper--mid">
                        <h3 className="reuse-filter__opt--cnt__title">
                            <FontAwesomeIcon 
                                icon={['far', 'comments']} 
                                className="icon icon__reuse-ads-filter--comment"/>
                            Comments
                        </h3>
                    ...
                    <div className="reuse-filter__opt--cnt__wrapper reuse-filter__opt--cnt__wrapper--mid">
                        <h3 className="reuse-filter__opt--cnt__title">
                            <FontAwesomeIcon 
                                icon={['far', 'eye']} 
                                className="icon icon__reuse-ads-filter--view"/>  
                            views
                        </h3>
                        <ul className="reuse-filter__opt--cnt__det">
                            <FilterOptions
                    ...
                    <div className="reuse-filter__opt--cnt__wrapper reuse-filter__opt--cnt__wrapper--mid">
                        <h3 className="reuse-filter__opt--cnt__title">
                            <FontAwesomeIcon 
                                icon={['fas', 'heart']} 
                                className="icon icon__reuse-ads-filter--fav"/>  
                            Favorites
                        </h3>
                        <ul className="reuse-filter__opt--cnt__det">
                            <FilterOptions
