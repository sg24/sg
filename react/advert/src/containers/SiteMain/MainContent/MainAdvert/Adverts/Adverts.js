...
class Adverts extends Component {
    ...
    componentDidUpdate() {
        ...
        if (this.props.match.params.id && this.state.filterTag !== this.props.match.params.id && this.props.match.params.id !== 'share' && this.props.match.params.id !== 'preview'  && this.props.match.params.id !== 'aroundme' && this.props.match.params.id !== 'filter' && this.props.match.params.id !== 'startfilter') {
        ...
        if (!this.props.match.params.id && this.state.filterTag !== 'advert') {
            this.props.onFetchCntReset();
    ...
    onScroll = () => {
        if ((window.innerHeight + Math.ceil(window.pageYOffset + 1)) >= document.body.offsetHeight) {
            this.props.onFetchCnt(
                    ...
                    this.state.filterTag === 'filter' ?  'filter=='+this.props.filterDet : this.state.filterTag : 'advert',
    ...
    showShareHandler = (shareID) => {
        ...
        this.props.history.push('/advert/share')
    };
    ...
    changeCntHandler = (id, title, det) => {
        if ( this.props.match.params.id === 'myadvert') {
    ...
    previewHandler = (media) => {
        this.props.history.push(`/advert/preview`);
