        ...
        return (
            <div className="site-main__chat--nav">
                <div className="site-main__chat--nav__wrapper">
                    ...
                    <div className="site-main__chat--nav__header">
                        <div className="site-main__chat--nav__header--det">
                            ...
                            <h4 className="site-main__chat--nav__header--det__title">
                                Chat Room
                            </h4>
                        </div>
                        <div className="site-main__chat--nav__header--srch">
                            <input type="text" className="site-main__chat--nav__header--srch__input" placeholder="Search User" />
                            <div>
