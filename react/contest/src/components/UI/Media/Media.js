...
class Carousel extends Component {
  ...
  playVideoHandler = (cnt) => {
	  this.setState({video: {url: `${window.location.protocol + '//' + window.location.host}/media/video/${cnt.videoCnt}`, id: cnt.id}})
  }
  ...
  render(){
	...
	let src = media.videoCnt ? {url: `${window.location.protocol + '//' + window.location.host}/media/image/${media.id}`, ...media, mediaType: 'snapshot'} : 
        {url: `${window.location.protocol + '//' + window.location.host}/media/image/${media.id}`, ...media, mediaType: 'image'};
    let playVideo = null;
	let control = null;
