...
export const submit = () => {
    return dispatch => {
        ...
        let removedMedia = localStorage.getItem('removedMedia') ? localStorage.getItem('removedMedia') : null;
        ...
        function upload() {
            ...
            if (removedMedia !== null) {
                formContent.append('removedmedia', removedMedia)
            }
            
            axios.post('/edit/qchat', formContent, {
