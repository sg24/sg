...
export const fetchQchatInit = (id) =>  {
    return {
        type: actionTypes.FETCH_QCHAT_INIT,
        id
    }; 
}; 


export const fetchQchatStart = () =>  {
    return {
        type: actionTypes.FETCH_QCHAT_START
    }; 
}; 

export const fetchQchatFail = (err) =>  {
    return {
        type: actionTypes.FETCH_QCHAT_FAIL,
        err
    }; 
}; 

export const fetchQchat = (qchat) =>  {
    return {
        type: actionTypes.FETCH_QCHAT,
        qchat
    }; 
}; 